...
var createVariable = function(props) {
  ...
  return _obj = {}, _define_property(_obj, IS_VAR, !0), _define_property(_obj, "key", key), _define_property(_obj, "name", skipHash ? "" : simpleHash(name, 40)), _define_property(_obj, "val", val), _define_property(_obj, "variable", isWeb ? skipHash ? constructCSSVariableName(name) : createCSSVariable(name) : ""), _obj;
};
