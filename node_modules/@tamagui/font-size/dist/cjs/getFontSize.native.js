...
var import_core = require("@tamagui/core"), getFontSize = function(inSize, opts) {
  ...
  if (typeof inSize == "number")
    return null;
  var relativeSize = (opts == null ? void 0 : opts.relativeSize) || 0, conf = (0, import_core.getConfig)(), fontSize = conf.fontsParsed[(opts == null ? void 0 : opts.font) || "$body"].size, _ref, size = (_ref = inSize === "$true" && !("$true" in fontSize) ? "$4" : inSize) !== null && _ref !== void 0 ? _ref : "$true" in fontSize ? "$true" : "$4", sizeTokens = Object.keys(fontSize), foundIndex = sizeTokens.indexOf(size);
