...
var require_config_native = __commonJS({
  "../web/dist/cjs/config.native.js"(exports2, module2) {
    ...
    var conf, setConfig = function(next) {
      ...
      if (!conf)
        throw new Error("Missing tamagui config, you either have a duplicate config, or haven't set it up. Be sure createTamagui is called before rendering. Also, make sure all of your tamagui dependencies are on the same version (`tamagui`, `@tamagui/package-name`, etc.) not just in your package.json, but in your lockfile.");
      return conf;
    }, tokensMerged;
  ...
  "../web/dist/cjs/helpers/insertStyleRule.native.js"(exports2, module2) {
    ...
    function addTransform(identifier, css, rule) {
      ...
      if (s !== -1) {
        ...
        if (!insertedTransforms2[identifier])
          return insertedTransforms2[identifier] = value, !0;
      }
    }
  ...
  "../web/dist/cjs/hooks/useMedia.native.js"(exports2, module2) {
    ...
    var mediaState2 = {}, mediaQueryConfig2 = {}, getMedia2 = function() {
      ...
      if (media) {
        ...
        for (var key in media)
          mediaState2[key] = (mediaQueryDefaultActive == null ? void 0 : mediaQueryDefaultActive[key]) || !1, mediaKeys.add("$".concat(key));
    ...
    function setupMediaListeners() {
      ...
      if (!(import_constants.isWeb && import_constants.isServer) && setupVersion !== mediaVersion) {
        ...
        for (var key in mediaQueryConfig2)
          _loop(key);
      }
    }
  ...
  "../web/dist/cjs/helpers/ThemeManager.native.js"(exports2, module2) {
    ...
    function getState(props, manager) {
      if (props.name && props.reset)
        throw new Error("Cannot reset and set a new name at the same time.");
      ...
      var Component = staticConfig.Component, isText = staticConfig.isText, isZStack = staticConfig.isZStack, isHOC = staticConfig.isHOC, _staticConfig_validStyles = staticConfig.validStyles, _$validStyles = _staticConfig_validStyles === void 0 ? {} : _staticConfig_validStyles, _staticConfig_variants = staticConfig.variants, variants = _staticConfig_variants === void 0 ? {} : _staticConfig_variants, component = /* @__PURE__ */ (0, import_react3.forwardRef)(function(propsIn, forwardedRef) {
        ...
        if ("themeInverse" in props && (themeStateProps.inverse = props.themeInverse), "theme" in props && (themeStateProps.name = props.theme), typeof curStateRef.isListeningToTheme == "boolean" && (themeStateProps.shouldUpdate = function() {
          ...
          if (console.info("%c ".concat(banner, " (hydrated: ").concat(isHydrated, ") (unmounted: ").concat(state.unmounted, ")"), "background: green; color: white;"), !import_constants.isServer)
            var pressLog, stateLog, ch, childLog;
        }
