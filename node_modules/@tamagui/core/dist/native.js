...
var require_insertStyleRule_native = __commonJS({
  "../web/dist/cjs/helpers/insertStyleRule.native.js"(exports2, module2) {
    ...
    function getTamaguiSelector(rule) {
      ...
      } else if (_instanceof1(rule, CSSMediaRule))
      ...
      var specificTokens = {}, themeConfig = function() {
        ...
        for (var key2 in tokens)
          for (var skey in tokens[key2]) {
            ...
            if (specificTokens["$".concat(key2, ".").concat(skey)] = variable, process.env.NODE_ENV === "development" && (typeof variable > "u" ? "undefined" : _type_of(variable)) > "u")
